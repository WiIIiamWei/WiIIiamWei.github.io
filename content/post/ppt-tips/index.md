...
* 像上图那样不按比例缩放物件，**特别是图片**。缩放图片时你总是应该**按住 Shift 等比例缩放**；
...
按住 Ctrl 的同时拖动物件可以复制该物件。

### 水平/垂直移动

按住 Shift 的同时拖动物件可以保证物件水平/垂直移动。

上述两个键可以一起按，达到**水平/垂直复制一个物件**的效果。不要给我再 Ctrl + C/Ctrl + V 了！

### 等比例缩放

按住 Shift 的同时缩放物件可以等比例缩放。在插入图形的时候按住 Shift 可以保证插入的图形长宽一致。

### 中心缩放

按住 Ctrl 的同时缩放物体可以使图形中心缩放。在插入图形的时候按住 Ctrl 可以保证绘制出的图形以光标初始落点为中心。
